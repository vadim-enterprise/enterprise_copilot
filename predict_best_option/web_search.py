        ...
        try:
            ...
            if filter_context:
                ...
                if context and isinstance(context, dict) and 'documents' in context:
                    ...
                    context_text = ' '.join(context['documents'][0][:10])  # Combine top 3 documents
            ...
            page = 1
            max_attempts = 100  # Maximum number of search pages to try
            ...
            while page <= max_attempts and consecutive_empty_pages < 15:  
